...
Public Class TaskBaseline_C
	...
	Public Function Item(ByVal Index As String) As TaskBaseline
		Return mp_oCollection.m_oItem(Index, SYS_ERRORS.MP_ITEM_1, SYS_ERRORS.MP_ITEM_2, SYS_ERRORS.MP_ITEM_3, SYS_ERRORS.MP_ITEM_4)
	End Function

	Public Function Add() As TaskBaseline
		mp_oCollection.AddMode = True
		Dim oTaskBaseline As New TaskBaseline()
	...
	Friend Sub WriteObjectProtected(ByRef oXML As clsXML)
		Dim lIndex As Integer
		Dim oTaskBaseline As TaskBaseline
		For lIndex = 1 To Count
		oTaskBaseline = mp_oCollection.m_oReturnArrayElement(lIndex)
