...
Public Class ResourceBaseline_C
	...
	Public Function Item(ByVal Index As String) As ResourceBaseline
		Return mp_oCollection.m_oItem(Index, SYS_ERRORS.MP_ITEM_1, SYS_ERRORS.MP_ITEM_2, SYS_ERRORS.MP_ITEM_3, SYS_ERRORS.MP_ITEM_4)
	End Function

	Public Function Add() As ResourceBaseline
		mp_oCollection.AddMode = True
		Dim oResourceBaseline As New ResourceBaseline()
	...
	Friend Sub WriteObjectProtected(ByRef oXML As clsXML)
		Dim lIndex As Integer
		Dim oResourceBaseline As ResourceBaseline
		For lIndex = 1 To Count
		oResourceBaseline = mp_oCollection.m_oReturnArrayElement(lIndex)
