...
Public Class WBSMask
	...
	Public Property yType() As E_TYPE_2
		Get
			Return mp_yType
		End Get
		Set(ByVal Value As E_TYPE_2)
			mp_yType = Value
		End Set
	End Property
	...
	Public Function IsNull() As Boolean
		...
		If mp_lLevel <> 0 Then
			bReturn = False
		End If
		If mp_yType <> E_TYPE_2.T_2_NUMBERS Then
			bReturn = False
		End If
		If mp_sLength <> "" Then
			bReturn = False
