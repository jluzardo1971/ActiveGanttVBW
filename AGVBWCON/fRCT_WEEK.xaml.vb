...
Public Class fRCT_WEEK
    ...
    Private Sub Window_Loaded(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        oView = ActiveGanttVBWCtl1.Views.Add(E_INTERVAL.IL_MINUTE, 20, E_TIERTYPE.ST_MONTH, E_TIERTYPE.ST_DAYOFWEEK, E_TIERTYPE.ST_DAYOFWEEK, "View1")
        oView.TimeLine.TierArea.MiddleTier.Visible = False
        oView.TimeLine.TickMarkArea.Visible = False

        ActiveGanttVBWCtl1.TierFormatScope = E_TIERFORMATSCOPE.TFS_CONTROL
        ActiveGanttVBWCtl1.TierFormat.DayOfWeekIntervalFormat = "ddd d"
        ...
        dtDate = New AGVBW.DateTime(2000, 1, 1, 0, 0, 0) 'RCT_WEEK's BaseDate will ignore Year, Month and Day values
